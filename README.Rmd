...
Installed from ***CRAN*** (can also from other repositories):dummies,e1071,adabag,C50,pROC,kknn,MASS,multiROC,caret,mlbench,randomForest,varSelRF,magrittr.
...
Installed from ***Bioconductor*** (can also from other repositories): ropls,mixOmics,multtest,AUC,metabolomics.
...
``` {r DifferentialAnalysis,eval = FALSE}
#Functional analysis
