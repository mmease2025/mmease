...
#'
#'
metabolic_differential <- function(data, labels, method = c("t_test", "ANOVA", "FC", "PLS-DA", "OPLS-DA", "RF_RFE", "Kruskal_Wallis", "svmrfeFeatureRanking"),
  ...
  labels <- as.numeric(as.factor(data[,3]))
